...
public class SExpToModelClassGenerator {
	...
	public void generate(EPackage source, JavaContentHandler content) {
		...
		// adds context
		String sexpToModelShortName = caller.getDependencyManager().getShortName("org.xid.basics.sexp.model.SExpToModel");
		content.beginAttribute(Java.PRIVATE | Java.FINAL, sexpToModelShortName, "context");
		content.endAttribute("context");
		
		String variableResolverShortName = caller.getDependencyManager().getShortName("org.xid.basics.sexp.VariableResolver");

...
public class JavaInterfaceGenerator {
	...
	public void generateInterfaceBeginning(EClass source, JavaContentHandler content) {
		...
		if ( caller.isGenerateModel() ) {
			String modelInterfaceName = caller.getDependencyManager().getShortName("org.xid.basics.model.ModelObject");
			interfaces.append(modelInterfaceName);
		}
		if ( caller.isGenerateBoost() ) {
			String boostInterfaceName = caller.getDependencyManager().getShortName("org.xid.basics.serializer.BoostObject");

...
public class ModelToSExpClassGenerator {
	...
	public void generate(EPackage source, JavaContentHandler content) {
		...
		// adds context
		String modelToSexpShortName = caller.getDependencyManager().getShortName("fr.minibilles.basics.sexp.model.ModelToSExp");
	...
	private void generateVisitMethod(EClass eClass, JavaContentHandler content) {
		...
		caller.getDependencyManager().getShortName("fr.minibilles.basics.sexp.SList");

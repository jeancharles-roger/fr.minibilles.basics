...
public class BoxEdgeDiagramGenerator extends GeneratorEntryPoint {
	...
	private void createDiagramClass(JavaContentFormatter content) {
		...
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.Diagram");
		...
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.DiagramController");
	...
	private void createBoxElementClass(JavaContentFormatter content) {
		...
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.Element");
		...
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.DiagramContext");
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.geometry.Geometry");
		...
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.gc.GC");
		getDependencyManager().getShortName("fr.minibilles.basics.ui.diagram.gc.GcUtils");
		getDependencyManager().getShortName("org.eclipse.swt.SWT");

...
public class XmlToModelClassGenerator {
	...
	public void generate(EPackage source, JavaContentHandler content) {
		...
		// adds referencer
		String referencerShortName = caller.getDependencyManager().getShortName("fr.minibilles.basics.sexp.model.Referencer");
		content.beginAttribute(Java.PRIVATE | Java.FINAL, referencerShortName, "referencer");
		content.endAttribute("referencer");
		
		// adds context
		final String sexpToModelShortName = caller.getDependencyManager().getShortName("fr.minibilles.basics.xml.XmlToModel");
	...
	private String getXmlTypeReadCall(EAttribute attribute, String value) {
		...
		final String xmlShortName = caller.getDependencyManager().getShortName("fr.minibilles.basics.xml.XML");
